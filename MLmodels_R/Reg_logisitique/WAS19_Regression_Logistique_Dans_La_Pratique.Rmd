...
```{r}
url <- "/home/flores-cuba/Documents/GIT_hub_Cod/Machine_learning/MLmodels_R/Reg_logisitique/data/heart.csv"
...
## on a vu que tout les variables sont pertinentes
...
print(test_lr)
# pour voire la signific globale
```
